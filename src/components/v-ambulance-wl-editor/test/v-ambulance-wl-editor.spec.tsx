...
import { VAmbulanceWlEditor } from '../v-ambulance-wl-editor';
import fetchMock from 'jest-fetch-mock';
import { Condition, WaitingListEntry } from '../../../api/ambulance-wl';

describe('v-ambulance-wl-editor', () => {
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      components: [VAmbulanceWlEditor],
      html: `<v-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></v-ambulance-wl-editor>`,
    });
